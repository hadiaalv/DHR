    ...
    <>
      ...
      <section className="container mx-auto px-6 py-16">
        ...
        <div className="text-center mt-12">
          <button className="bg-yellow-500 text-white px-8 py-3 rounded-lg font-semibold hover:bg-yellow-600 transition-colors shadow-lg">
            View All Properties
          </button>
        </div>
      </section>
      ...
      <section className="bg-gray-50 py-16">
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {/* Service 1 */}
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 text-center">
      ...
      <section className="py-16">
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold text-gray-800 mb-6">Why Choose Dream Heaven Realty?</h2>
      ...
      <section className="bg-yellow-500 text-white text-center py-16">
        <div className="container mx-auto px-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="bg-white text-yellow-500 px-8 py-4 rounded-lg font-semibold hover:bg-gray-100 transition-colors shadow-lg text-lg">
              Browse Properties
            </button>
            <button className="bg-gray-900 text-white px-8 py-4 rounded-lg font-semibold hover:bg-gray-800 transition-colors shadow-lg text-lg">
              Contact Us Today
            </button>
          </div>
        </div>
