    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#properties" className="text-gray-400 hover:text-yellow-500 transition-colors">Properties</a></li>
              <li><a href="#portfolio" className="text-gray-400 hover:text-yellow-500 transition-colors">Portfolio</a></li>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">&copy; 2024 Dream Heaven Realty LLC. All rights reserved.</p>
