    ...
    <footer className="bg-gray-50 text-gray-900 py-12 border-t border-gray-200">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-4">
              Your trusted partner in finding the perfect property. Excellence in real estate since 2009.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-600">Property Sales</li>
              <li className="text-gray-600">Property Rentals</li>
              <li className="text-gray-600">Property Management</li>
              <li className="text-gray-600">Investment Consulting</li>
              <li className="text-gray-600">Market Analysis</li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-200 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm">&copy; 2024 Dream Heaven Realty LLC. All rights reserved.</p>
